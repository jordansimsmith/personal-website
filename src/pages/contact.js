...
import {Container, Header, Icon, Form, Message, Button} from "semantic-ui-react";
	...
	<div>
		<Navigation/>
			...
			<Header as="h3" textAlign="center">
				<Header.Content>Message me on LinkedIn or send me an email below and I will get back to you.</Header.Content>
			</Header>

			<div className="center">
				<Button as="a" href="https://www.linkedin.com/in/jordansimsmith/" target="_blank" color="blue">My LinkedIn</Button>
			</div>
