				...
				<Item>
					...
					<Item.Content>
						...
						<Item.Description>
							...
							<p>My second year in the software course included language mechanics, algorithms, data structures, testing and software design. </p>
							<Header as="h4">Notable Courses</Header>
							<List bulleted>
								<List.Item>
									<List.Header>Object-Oriented Software Construction</List.Header>
									O-O mechanics in Java, with an emphasis on design patterns and what is good software design.
								</List.Item>
								<List.Item>
									<List.Header>Introduction to Data Structures and Algorithms</List.Header>
									Analysing the time complexity and correctness of algorithms and when to use which data structure.
								</List.Item>
								<List.Item>
									<List.Header>Quality Assurance</List.Header>
									Developing fault-free software as well as how to test for faults.
								</List.Item>
								<List.Item>
									<List.Header>Software Engineering Design</List.Header>
									A semester-long pair project using version control.
								</List.Item>			
							</List>
